...
**Last updated:** 2026-05-03 (post-migration + post-prune curator pass).

**Status (2026-05-03):** 169 open items remain (148 [ ] + 21 [~]). By priority: **P1 = 72** (65 open + 7 partial), **P2 = 42** (38 open + 4 partial), **P3 = 3** (2 open + 1 partial), **P4 = 26** (20 open + 6 partial), **P5 = 5** (5 open), **P6 = 13** (10 open + 3 partial), **P7 = 8** (8 open). Same-day curator changes: (a) 23 P3 items migrated from `DOCS_IMPLEMENTATION_PLAN.md` (D3.1, D3.4, D3.6, D3.11–D3.23, D3.27, D3.29, D3.36–D3.39, D3.43 → P1.163–P1.185); (b) all `[x]` closed bullets and FIXED `### P-code` subsections pruned — closure summaries retained in git history and `docs/appendix/changelog.md`; (c) before P2.47/P2.48 entries (Art. 136/137/138 ECAI-grade / MEIP / second-best lookup from D4.74; CR8 flow rows + signed-convention emission from D4.82) surfaced by docs batch b89fe59.
