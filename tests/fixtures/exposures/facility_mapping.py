...
def _corporate_facility_mappings() -> list[FacilityMapping]:
    ...
    return [
        ...
        # P1.169 — B31 ECRA short-term institution CQS 4 (F-INST-ST-001 -> L-INST-ST-001)
        ...
        # P1.107 — FCSM corporate-bond CQS 3 RW divergence scenario
        FacilityMapping("FAC_P1107", "LN_P1107", "loan"),
