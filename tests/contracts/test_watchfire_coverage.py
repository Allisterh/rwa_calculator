...
WHITELIST: list[tuple[str, str, tuple[str, ...]]] = [
    ...
    ("rwa_calc.data.tables.crr_risk_weights", "_create_rgla_df",
     ("CRR Art. 115",)),
    ("rwa_calc.data.tables.crr_risk_weights", "_create_pse_df",
     ("CRR Art. 116",)),
    ("rwa_calc.data.tables.crr_risk_weights", "_create_mdb_df",
     ("CRR Art. 117",)),
    ("rwa_calc.data.tables.crr_risk_weights", "_create_io_df",
     ("CRR Art. 118",)),
    ("rwa_calc.data.tables.crr_risk_weights", "build_institution_guarantor_rw_expr",
     ("CRR Art. 119", "CRR Art. 120", "CRR Art. 121")),
