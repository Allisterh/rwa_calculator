...
# ---------------------------------------------------------------------------
# Inline data schemas (projected from the production ColumnSpec schemas — the
# inline-data builders below populate a verbatim subset of these columns; the
# loader / pipeline treat the unset production columns as null, exactly as a
# parquet load would.  CRR Art. 207(2): is_sft on FACILITY_SCHEMA / LOAN_SCHEMA
# drives the repo / SFT eligibility path so covered_bond collateral routes
